  ...
  <body>
    ...
    <div style="background-color:purple;" class="sidebar">
      ...
      <div class="menu">
        <ul>
          ...
          <li> <a href="add/addmen.php"  style="color: white;"><i class="fa-solid fa-plus"></i> Add Product</li></a>
          <?php endif; ?>
    ...
    <div class="content">
      ...
      <div style="display: flex; height:30%" class="sale">
        ...
        <div >
          <img style="height:100%" src="https://www.barkersonline.co.nz/media/wysiwyg/Barkers_Mid_Season_Sale_Home_Page_Banner_Desktop1.jpg" alt="">
        </div>
        <div >
          <img style="height:100%" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRl-FuiKg2Fk9n8DwFq03_lNXRioT8ePMiboA&usqp=CAU" alt="">
        </div> 
        <div >
          <img style="height:100%" src="https://assetscdn1.paytm.com/images/catalog/view_item/787364/1617369686163.jpg?imwidth=480&impolicy=hq" alt="">
        </div> 
      ...
      ?>
        ...
        <?php  while($row = mysqli_fetch_assoc($result)): ?>
          ...
          <div style="height: 50vh; width:150%" class="product">
            ...
            <div class="addbutton">
               <a href="addtocart.php?id=<?php echo $row['id'] ?>"><button class="addtocart">ADD TO CART</button></a> <br>
          <?php  if(isset($_SESSION['auth']) && $_SESSION['auth']['permision'] == 'admin'  ) : ?>
               <a href="delete/deletemen.php?id=<?php echo $row['id'] ?>"><button class="addtocart">DELETE</button></a>  
               <?php endif; ?>
               </div>
            <div class="subtitle">
              <div class="name">
